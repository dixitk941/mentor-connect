      ...
      <nav aria-label="Global" className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8">
        <div className="flex lg:flex-1">
          <a href="/" className="-m-1.5 p-1.5">
            ...
            <img alt="" src="https://firebasestorage.googleapis.com/v0/b/mentor-connect-74cc5.appspot.com/o/Logo.png?alt=media&token=9a3674d4-df33-48c0-b324-d16bdffe91ba" className="h-8 w-auto" />
          </a>
        </div>
