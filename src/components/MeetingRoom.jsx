...
const MeetingRoom = () => {
  ...
  return (
    ...
    >
      ...
      {chatVisible && (
        <div className="absolute bottom-20 right-4 w-80 h-96 bg-white shadow-lg rounded-lg overflow-hidden">
          <Chat />
        </div>
      )}
      {notesVisible && (
        <div className="absolute bottom-20 left-4 w-80 h-96 bg-white shadow-lg rounded-lg overflow-hidden">
          <Notes />
        </div>
      )}
    </div>
